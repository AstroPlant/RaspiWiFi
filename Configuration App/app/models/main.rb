...
class Main < ActiveRecord::Base
  ...
  def self.create_astroplant_config(user_api_url, user_ws_url, user_auth_serial ,user_auth_secret)
    ...
    kit_temp_conf_file.puts '            "module_name": "astroplant_peripheral_device_library.lcd",'
    kit_temp_conf_file.puts '            "class_name": "LCD",'
    kit_temp_conf_file.puts '            "parameters": {'
    kit_temp_conf_file.puts '                "i2c_address": "0x3f"'
    kit_temp_conf_file.puts '             }'
    kit_temp_conf_file.puts '        }'
    kit_temp_conf_file.puts '    }'
    kit_temp_conf_file.puts '}'
